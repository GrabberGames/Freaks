...
Shader "Unlit/Trail_Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult39 = lerp( _Color2 , _Color3 , ( (0.0 + (i.uv_texcoord.x - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) + 0.0 ));
...
/*ASEBEGIN
Version=18301
2;1;1762;901;2216.735;-1.013977;1.365747;True;True
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-1976.341,-88.3905;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;29;-1913.536,318.2651;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-1751.093,929.1444;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-1716.576,-132.524;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;32;-1574.438,152.6512;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;6,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TFHCRemapNode;45;-1469.154,969.7737;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;36;-1138.477,601.6525;Inherit;False;Property;_Color2;Color 2;4;0;Create;True;0;0;False;0;False;1,1,1,0;1,0.6367924,0.8916396,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;34;-1344.838,409.5718;Inherit;True;Property;_TextureSample3;Texture Sample 3;8;0;Create;True;0;0;False;0;False;-1;None;135e2a81601334c4ba1f11e0bae3f16e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;37;-1244.552,768.3076;Inherit;False;Property;_Color3;Color 3;5;0;Create;True;0;0;False;0;False;0,0,0,0;1,0,0.7853518,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7BA06CE0C44A2C2C301EC2B21BBDB5ACCEBE08C9